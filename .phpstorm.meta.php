...
'register.index','register.store','logout','trackers.index','storage.local',);
        registerArgumentsSet('views', 
'auth.login','auth.register','base','components.flash-message','components.form-button',
'components.form-input','components.stats-card','home.index','trackers.index','laravel-exceptions-renderer::components.card',
